  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Забота о здоровье
          <span className="block text-sage">рядом с вами</span>
        </h1>

        <p
          className={`text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-12 transition-all duration-1000 delay-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          Запишитесь к врачу, узнайте о симптомах и получите информацию о лекарствах — просто и понятно.
        </p>
        ...
        >
          <a
            href="#services"
            className="group inline-flex items-center gap-3 px-10 py-5 bg-sage text-primary-foreground text-base tracking-widest uppercase hover:bg-sage/90 transition-all duration-500"
          >
            Начать
            <svg
